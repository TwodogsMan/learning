...
def get_vote_model_cn(agents: list[Any]) -> type[BaseModel]:
    """获取中文版投票模型"""
...
def get_seer_model_cn(agents: list[Any]) -> type[BaseModel]:
    """获取中文版预言家模型"""
...
def get_hunter_model_cn(agents: list[Any]) -> type[BaseModel]:
    """获取中文版猎人模型"""
